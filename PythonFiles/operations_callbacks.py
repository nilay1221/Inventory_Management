            ...
            for i in range(10):
                try:
                    if self.uiWindow.tableWidget.item(i, 0).text():
                        try:
                            if self.uiWindow.tableWidget.item(i, 0).text() and self.uiWindow.tableWidget.item(i,
                                                                                                              2).text():
                                pass
                            if self.uiWindow.tableWidget.item(i, 0).text() == "" or self.uiWindow.tableWidget.item(i,
                                                                                                                   2).text() == "":
            ...
            for i in range(10):
                try:
                    if self.uiWindow.shade_new_modify_details_table.item(i, 0).text():
                        try:
                            if self.uiWindow.shade_new_modify_details_table.item(i,
                                                                                 0).text() and self.uiWindow.shade_new_modify_details_table.item(
                                    i, 2).text():
                                pass
...
def shade_view_all(self):
    ...
    for row_number, row_data in enumerate(results):
        ...
        for column_number, data in enumerate(row_data):
            self.uiWindow.shade_new_viewall_details_table.setItem(row_number, column_number,
                                                                  QtWidgets.QTableWidgetItem(str(data)))
...
def add_raw_material_callback(self):
    ...
    if customer and remark:
        ...
        if check_table == "True":
            ...
            for i in range(8):
                try:
                    if self.uiWindow.rm_addtable.item(i, 0).text() and self.uiWindow.rm_addtable.item(i,
                                                                                                      2).text() and self.uiWindow.rm_addtable.item(
                            i, 3).text():
            ...
            for column in range(len(results[row])):
                if column == 0:
                    if str(results[row][column]) not in trans_list:
                        ...
                        self.uiWindow.rm_view_table_5.setItem(row, column,
    ...
    if check_rm_transacs(trans_id):
        ...
        if customer and remark:
            ...
            if check_table == "True":
                ...
                for i in range(8):
                    try:
                        if self.uiWindow.rm_view_table.item(i, 0).text() and self.uiWindow.rm_view_table.item(i,
                                                                                                              2).text() and self.uiWindow.rm_view_table.item(
                                i, 3).text():
                ...
                try:
                    ...
                    try:
                        ...
                        for i in range(row_count_1):
                            if self.uiWindow.shade_addtable.item(i, 0).text() and self.uiWindow.shade_addtable.item(i,
                                                                                                                    2).text() and self.uiWindow.shade_addtable.item(
                                    i, 3).text():
                        ...
                        try:
                            ...
                            for i in range(len(raw_details)):
                                temp = [self.uiWindow.shade_addtable.item(i, 0).text(),
                                        self.uiWindow.shade_addtable.item(i, 3).text()]
                            ...
                            if checkrepeat == 0:
                                ...
                                # print(results)
                                if add_raw_material_data(self, negative_trans_id, date, customer, remark, results,
                                                         type="OUT"):
                                    add_shade_stock_trans(self, trans_id, date, customer, remark, shade_number,
                                                          raw_details)
        ...
        for each_row in range(len(table1_details)):
            ...
            for each_column in range(len(table1_details[each_row])):
                ...
                if table1_details[each_row][each_column] != '-':
                    self.uiWindow.shade_addtable_4.setItem(each_row, each_column, QtWidgets.QTableWidgetItem(
                        str(table1_details[each_row][each_column])))
        ...
        for each_row in range(len(table1_details)):
            ...
            for each_column in range(len(table1_details[each_row])):
                if each_column == 2:
                    total_quantity += table1_details[each_row][each_column]
                if table1_details[each_row][each_column] != '-':
                    self.uiWindow.shade_addtable_2.setItem(each_row, each_column, QtWidgets.QTableWidgetItem(
                        str(table1_details[each_row][each_column])))
        table2_details = results['table2_detials']
...
def set_modify_shade_transaction(self):
    ...
    if check_shade_trans(trans_id):
        ...
        for each_row in range(len(table1_details)):
            ...
            for each_column in range(len(table1_details[each_row])):
                if each_column == 2:
                    total_quantity += table1_details[each_row][each_column]
                if table1_details[each_row][each_column] != '-':
                    self.uiWindow.shade_addtable_3.setItem(each_row, each_column, QtWidgets.QTableWidgetItem(
                        str(table1_details[each_row][each_column])))
        table2_details = results['table2_detials']
        ...
        for row in range(len(table2_details)):
            ...
            for column in range(len(table2_details[row])):
                if table2_details[row][column] != '-':
                    self.uiWindow.shade_colortable_3.setItem(row, column, QtWidgets.QTableWidgetItem(
                        str(table2_details[row][column])))
                    ...
                    if table_check == "True":
                        try:
                            ...
                            try:
                                ...
                                raw_details = []
                                for i in range(row_count_1):
                                    if self.uiWindow.shade_addtable_3.item(i,
                                                                           0).text() and self.uiWindow.shade_addtable_3.item(
                                            i, 2).text() and self.uiWindow.shade_addtable_3.item(i, 3).text():
                                ...
                                try:
                                    ...
                                    if checkrepeat == 0:
                                        ...
                                        if add_raw_material_data(self, negative_trans_id, date, customer, remark,
                                                                 results, type="OUT"):
                                            add_shade_stock_trans(self, trans_id, date, customer, remark, shade_number,
                                                                  raw_details)
                                            add_into_duplicates(trans_id, negative_trans_id)
        ...
        if customer and remark:
            ...
            if checktable == "True" and tableflag == 0:
                    ...
                    try:
                        if self.uiWindow.sales_add_table.item(i, 0).text():
                            try:
                                self.uiWindow.sales_add_table.item(i, 1).text()
                                self.uiWindow.sales_add_table.item(i, 3).text()
                                if self.uiWindow.sales_add_table.item(i,
                                                                      0).text() == '' or self.uiWindow.sales_add_table.item(
                        ...
                        try:
                            if self.uiWindow.sales_add_table.item(i,
                                                                  1).text() != '' or self.uiWindow.sales_add_table.item(
                                    i, 3).text() != '':
                                self.show_warning_info(f"Please fill info in the table at '{i + 1}'")
                                flag = 1
                                break
                ...
                if flag == 0:
                    for i in range(8):
                        try:
                            if self.uiWindow.sales_add_table.item(i, 0).text() and self.uiWindow.sales_add_table.item(i,
                                                                                                                      1).text() and self.uiWindow.sales_add_table.item(
                                    i, 3).text():
        ...
        for row in range(len(results)):
            ...
            for column in range(len(results[row])):
                if column == 0:
                    if str(results[row][column]) not in trans_list:
                        trans_list.append(str(results[row][column]))
                        self.uiWindow.sales_view_today_table.setItem(row, column, QtWidgets.QTableWidgetItem(
                            str(results[row][column])))
                elif results[row][column] != '-':
                    self.uiWindow.sales_view_today_table.setItem(row, column,
                                                                 QtWidgets.QTableWidgetItem(str(results[row][column])))
    else:
        self.show_info_popup("No Transactions Done Today")
...
def raw_material_display_closing(self):
    try:
        ...
        for row_number, row_data in enumerate(results):
            ...
            for column_number, data in enumerate(row_data):
                self.uiWindow.rm_closing_stock_table.setItem(row_number, column_number,
                                                             QtWidgets.QTableWidgetItem(str(data)))
                if column_number == 0:
                    self.uiWindow.rm_closing_stock_table.setItem(row_number, column_number + 2,
                                                                 QtWidgets.QTableWidgetItem(
                                                                     str(raw_material_closing_stock(data, 'all'))))
                    ...
                    if raw_material_closing_stock(data, 'all') != "None":
                        if float(raw_material_closing_stock(data, 'all')) > 0:
                            self.uiWindow.rm_closing_stock_table.item(row_number, column_number + 2).setBackground(
                                QtGui.QColor(84, 237, 78))
                        else:
                            self.uiWindow.rm_closing_stock_table.item(row_number, column_number + 2).setBackground(
                                QtGui.QColor(240, 79, 79))
...
def colour_display_closing(self):
    try:
        ...
        for row_number, row_data in enumerate(results):
            ...
            for column_number, data in enumerate(row_data):
                self.uiWindow.colour_closing_stock_table.setItem(row_number, column_number,
                                                                 QtWidgets.QTableWidgetItem(str(data)))
                if column_number == 0:
                    self.uiWindow.colour_closing_stock_table.setItem(row_number, column_number + 2,
                                                                     QtWidgets.QTableWidgetItem(
                                                                         str(raw_material_closing_stock(data, 'all'))))
                    if raw_material_closing_stock(data, 'all') != "None":
                        if float(raw_material_closing_stock(data, 'all')) > 0:
                            self.uiWindow.colour_closing_stock_table.item(row_number, column_number + 2).setBackground(
                                QtGui.QColor(84, 237, 78))
                        else:
                            self.uiWindow.colour_closing_stock_table.item(row_number, column_number + 2).setBackground(
                                QtGui.QColor(240, 79, 79))
                    ...
                    for column_number in range(1):
                        if column_number == 0:
                            if self.uiWindow.shade_closing_stock_table.item(row_number,
                                ...
                                if str(x) != "None":
                                    if float(x) > 0:
                                        self.uiWindow.shade_closing_stock_table.item(row_number,
                                                                                     column_number + 3).setBackground(
                                            QtGui.QColor(84, 237, 78))
                                    else:
                                        self.uiWindow.shade_closing_stock_table.item(row_number,
                                                                                     column_number + 3).setBackground(
