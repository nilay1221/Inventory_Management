...
.stackedWidget.setCurrentIndex(pagesDict['new_shade_operations']))
        ...
        self.uiWindow.rw_view_starting_date.setMinimumDate(QtCore.QDate(2020,4,1))
        self.uiWindow.rw_view_ending_date.setMinimumDate(QtCore.QDate(2020,4,1))
        self.uiWindow.rw_view_starting_date.setMaximumDate(QtCore.QDate.currentDate())
        self.uiWindow.rw_view_ending_date.setMaximumDate(QtCore.QDate.currentDate())
        self.uiWindow.rw_view_ending_date.setDate(QtCore.QDate.currentDate())
        self.uiWindow.rw_view_starting_date_3.setMinimumDate(QtCore.QDate(2020,4,1))
        self.uiWindow.rw_view_ending_date_2.setMinimumDate(QtCore.QDate(2020,4,1))
        self.uiWindow.rw_view_starting_date_3.setMaximumDate(QtCore.QDate.currentDate())
        self.uiWindow.rw_view_ending_date_2.setMaximumDate(QtCore.QDate.currentDate())
        self.uiWindow.rm_view_today_date.setDate(QtCore.QDate.currentDate())
        self.uiWindow.shade_view_start_date.setMinimumDate(QtCore.QDate(2020,4,1))
        self.uiWindow.shade_view_end_date.setMinimumDate(QtCore.QDate(2020,4,1))
        self.uiWindow.shade_view_start_date.setMaximumDate(QtCore.QDate.currentDate())
        self.uiWindow.shade_view_end_date.setMaximumDate(QtCore.QDate.currentDate())
        self.uiWindow.shade_view_today_date.setDate(QtCore.QDate.currentDate())
        self.uiWindow.rw_view_starting_date_4.setMinimumDate(QtCore.QDate(2020,4,1))
        self.uiWindow.rw_view_ending_date_3.setMinimumDate(QtCore.QDate(2020,4,1))
        self.uiWindow.rw_view_starting_date_4.setMaximumDate(QtCore.QDate.currentDate())
        self.uiWindow.rw_view_ending_date_3.setMaximumDate(QtCore.QDate.currentDate())
        self.uiWindow.shade_view_starting_date.setMinimumDate(QtCore.QDate(2020,4,1))
        self.uiWindow.shade_view_ending_date.setMinimumDate(QtCore.QDate(2020,4,1))
        self.uiWindow.shade_view_starting_date.setMaximumDate(QtCore.QDate.currentDate())
        self.uiWindow.shade_view_ending_date.setMaximumDate(QtCore.QDate.currentDate())
        self.uiWindow.sales_view_by_today_date.setDate(QtCore.QDate.currentDate())
        self.uiWindow.sales_view_custom_start_date.setMinimumDate(QtCore.QDate(2020,4,1))
        self.uiWindow.sales_view_custom_end_date.setMinimumDate(QtCore.QDate(2020,4,1))
        self.uiWindow.sales_view_custom_start_date.setMaximumDate(QtCore.QDate.currentDate())
        self.uiWindow.sales_view_custom_end_date.setMaximumDate(QtCore.QDate.currentDate())
