...
class MainWindow(QMainWindow):
    ...
    def startUIWindow(self):
        ...
        self.uiWindow.back_view_rm_3.clicked.connect(lambda : self.uiWindow.stackedWidget.setCurrentIndex(pagesDict['Home']))
        self.uiWindow.op_back.clicked.connect(lambda : self.uiWindow.stackedWidget.setCurrentIndex(pagesDict['rm_operations']))
        self.uiWindow.view_trans.clicked.connect(lambda : self.uiWindow.stackedWidget.setCurrentIndex(pagesDict['rm_stock_view']))
